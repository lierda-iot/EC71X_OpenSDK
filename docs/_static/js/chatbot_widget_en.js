/**
 * Chatbot Widget - English Version
 *
 * This script loads the Kapa AI chatbot widget for English documentation.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Project branding
  script.setAttribute("data-project-name", "Lierda LTE-EC71X OpenCPU");
  ...
  script.setAttribute(
    "data-button-image",
    "https://your-domain.com/chatbot-icon.png",
  );
  ...
  script.setAttribute(
    ...
    "0px 6px 12px 1px rgba(0,0,0,0.16)",
  );
  ...
  script.setAttribute(
    ...
    "This custom large language model (LLM) is designed to provide technical support " +
      "and answers related to the project documentation. Give it a try, share your thoughts, " +
      "and let us know your feedback—we truly appreciate it!\n\n" +
      "**Note**: AI-generated information may be incomplete or inaccurate. " +
  ...
  script.setAttribute(
    ...
    "What is this project?,How do I get started?,Where is the API documentation?",
  );
